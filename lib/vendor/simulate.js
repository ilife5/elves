...
;(function($) {
    ...
    $.simulate = function(el, type, options) {
        ...
        if (/^tap|doubleTap|press|longTap|swipe|swipe(Right|Left|Up|Down)$/i.test(type)) {
    ...
    var sim = $.extend($.simulate.prototype, {
        ...
        createEvent: function(type, options, el) {
            ...
            } else if  (/^touch(over|out|start|end|move)$/i.test(type)) {
        ...
        touchEvent: function(type, options, el) {
            ...
            var touch = document.createTouch(window, el, new Date().getTime(),
                pos.pageX, pos.pageY, pos.screenX, pos.screenY, pos.clientX, pos.clientY);

            var evt = document.createEvent("UIEvent");

            evt.initUIEvent(type, true, true, window, null);
    ...
    function getGestures(type){
        ...
        gestures.longTap = gestures.press
